                        ...
                        <select class="form-control supplier-select2" name="supplier_id" required multiple>
                            @foreach ($suppliers as $supplier)
                                <option value="{{ $supplier->name }}"
                                    @if ($supplier->id == $purchase->supplier_id) selected="true" @endif>{{ $supplier->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row invoice-form">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" id="received" name="received" class="form-control" min="0"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <strong>
                                                ...
                                                @endif
                                                &nbsp;
                                                <a href="{{ url('/admin/purchases/purchaseitems/delete/' . $item->id) }}"
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($purchase->received != 0)
                                            <h5><strong><span id="taxAmount">{{ $purchase->received }}</span></strong>
                                            </h5>
                                            <h5 id="totalPayment" class="text-danger">
                                                <strong>{{ $purchase->remained }}</strong>
                                            </h5>
                                        @endif
                                    </td>
                                </tr>
